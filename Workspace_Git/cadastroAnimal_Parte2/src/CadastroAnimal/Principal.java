...
public class Principal {
	...
	public static void main(String[] args) {
		...
		listaMenu.append("Digite '1' para Cad CACHORRO").append( v_enter )
		         .append("Digite '2' para Cad COBRA").append( v_enter )
		         .append("Digite '3' para Imprime CACHORRO").append( v_enter )
		         .append("Digite '4' para Imprime COBRA").append( v_enter )
		         .append("Digite '5' para Sair...");
	...
	public static void exibeDados (List<Cachorro> 	cachorroLista
                                  ,List<Cobra> 	    cobraLista
                                  ,int      v_opcao) {
		...
		if (v_opcao == 3) {
			...
			for (Cobra cobraItemLista:cobraLista) {
				impressaoString.append("Nome: ").append( cobraItemLista.getNome()).append(v_enter)
                               .append("Idade: ").append( cobraItemLista.getIdade()).append(v_enter)
