...
import controller.menu.CtlFrmMainMenuCorrentistaPremium;

public class FrmMainMenuCorrentistaPremium {
	public void menu() {
		//
		...
		//
		JLabel lblCabecalho = new JLabel("[ MENU CORRENTISTA PREMIUM ]");
		...
		//
		CtlFrmMainMenuCorrentistaPremium ctlFrmMainCorrentistaPremium = new CtlFrmMainMenuCorrentistaPremium(tfBoxOption,
				frmMainForm);
		btOption.addActionListener(ctlFrmMainCorrentistaPremium);
