...
import controller.CorrentistaBasico.CtlFrmAlteracaoCorrentistaBasicoSel;
import entity.EntCorrentistaBasico;
import entity.EntEndereco;

public class FrmAlteracaoCorrentistaBasicoSel {

	public void alteracaoCorrentistaSel(List<EntCorrentistaBasico> listaCorrentista) {
		...
		CtlFrmAlteracaoCorrentistaBasicoSel ctlFrmAlteracaoCorrentistaBasicoSel = new CtlFrmAlteracaoCorrentistaBasicoSel(
				cpf, frameCorrentista);
		botaoExcluir.addActionListener(ctlFrmAlteracaoCorrentistaBasicoSel);
		botaoVoltar.addActionListener(ctlFrmAlteracaoCorrentistaBasicoSel);
