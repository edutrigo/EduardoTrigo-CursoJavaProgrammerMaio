...
public class SrvCriarPdf extends PdfPageEventHelper {
	...
	//
	public void gerarPdfCorrentistaBasico(EntCorrentistaBasico entCorrentista) {
		String caminhoArquivo = "C:\\Users\\edutr\\Downloads\\" + "RelatorioCorrentistaBasico-" + entCorrentista.getNome()
				+ ".pdf";
		...
		try {
			...
			System.out.println("Erro SrvCriarPdf.gerarPdfCorrentistaBasico: " + e.getMessage());
		}
	}

	//
	public void gerarPdfCorrentistaPremium(EntCorrentistaPremium entCorrentista) {
		String caminhoArquivo = "C:\\Users\\edutr\\Downloads\\" + "RelatorioCorrentistaPremium-" + entCorrentista.getNome()
				+ ".pdf";
		...
		try {
			...
			document.add(new Paragraph("Relatorio de CORRENTISTA PREMIUM",
					FontFactory.getFont(FontFactory.HELVETICA_BOLD, 14)));
			...
			if (entCorrentista != null) {
				...
				//
				table.addCell("LIM CREDITO");
				if (vldCampos.campoNullBranco(Double.toString(entCorrentista.getLimiteDeCredito()))) {
					table.addCell("Não informado");
				} else {
					table.addCell(Double.toString(entCorrentista.getLimiteDeCredito()));
				}
			...
			System.out.println("Erro SrvCriarPdf.gerarPdfCorrentistaPremium: " + e.getMessage());
		}
	}
